...
f.write('Initial condition: Particle_Number = ' + str(N*4+N*4) + ' Steps = ' + str(Steps))
...
plt.figure(2)
plt.scatter(Plot_Particle1[:, 0, 0], Plot_Particle1[:, 0, 1], marker='.', label='MW')
plt.scatter(Plot_Particle2[:, 0, 0], Plot_Particle2[:, 0, 1], marker='.', label='M31')
