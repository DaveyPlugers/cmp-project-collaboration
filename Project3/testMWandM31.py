...
f.write('Initial condition: ParticleNumber = ' + str(N*4+N*4) + ' Steps = ' + str(Steps))
...
plt.figure(2)
plt.scatter(PlotParticle1[:, 0, 0], PlotParticle1[:, 0, 1], marker='.', label='MW')
plt.scatter(PlotParticle2[:, 0, 0], PlotParticle2[:, 0, 1], marker='.', label='M31')
